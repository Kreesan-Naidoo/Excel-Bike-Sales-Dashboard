...
This project transforms **1,000 records of raw bike sales data** into a clean, interactive dashboard using **Microsoft Excel**. The goal was to practise the full analyst workflow — from raw data and cleaning through to a polished, filterable dashboard that communicates sales insights at a glance.
 ...
 ![Dashboard Preview](bike%20-sales%20dashboard-screenshot.png)
---
...
| Skill | Application |
|---|---|
| Data Cleaning | Removed duplicates, standardised values, preserved raw data |
| Calculated Columns | Nested IF statements to create age bracket groupings |
| Pivot Tables | Multi-dimensional summaries across income, age, commute distance |
| Pivot Charts | Visual representation of each pivot table analysis |
| Slicers | Interactive filtering across marital status, region, education |
| Dashboard Design | Single-page consolidated view of all insights |
